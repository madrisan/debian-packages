...
* Debian source package:
  * [[vault_1.7.7-1.dsc]][vault-dsc]
  * [[vault_1.7.7.orig.tar.gz]][vault-orig]
  * [[vault_1.7.7-1.debian.tar.xz]][vault-debian]

* Debian 9 (Stretch) binary packages:
  * [[vault_1.7.7-1_amd64.deb]][vault-debpkg]
  * [[vault-server_1.7.7-1_amd64.deb]][vault-server-debpkg]

* Debian 10 (Buster) binary packages:
  * version 1.7.7
    * [[vault_1.7.7-1_amd64.deb]][vault-debpkg-deb10]
    * [[vault-server_1.7.7-1_amd64.deb]][vault-server-debpkg-deb10]
---
...
[vault-debpkg]: https://github.com/madrisan/debian-packages/releases/download/v0.6.0/vault_1.7.7-1_amd64.deb
[vault-server-debpkg]: https://github.com/madrisan/debian-packages/releases/download/v0.6.0/vault-server_1.7.7-1_amd64.deb
[vault-debian]: https://github.com/madrisan/debian-packages/releases/download/v0.6.0/vault_1.7.7-1.debian.tar.xz
[vault-dsc]: https://github.com/madrisan/debian-packages/releases/download/v0.6.0/vault_1.7.7-1.dsc
[vault-orig]: https://github.com/madrisan/debian-packages/releases/download/v0.6.0/vault_1.7.7.orig.tar.gz

[vault-debpkg-deb10]: https://github.com/madrisan/debian-packages/releases/download/v0.7.0/vault_1.7.7-1_amd64.deb
[vault-server-debpkg-deb10]: https://github.com/madrisan/debian-packages/releases/download/v0.7.0/vault-server_1.7.7-1_amd64.deb
